...
@Component
class KakaoAuthTokenReadRepositoryAdapter(
    ...
    override fun invoke(request: KakaoAuthTokenReadRepository.Request): KakaoAuthTokenReadRepository.Result {
        ...
        return KakaoAuthTokenReadRepository.Result(
